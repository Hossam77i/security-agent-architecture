...
> Auto-fetched 2026-09-22 | Deduplicated across Telegram, GitHub, X/Twitter, H1, Writeups
...
| awesome-msrc-writeups | https://github.com/bribes/awesome-msrc-writeups | Microsoft MSRC writeups with bounty amounts |
| BountyHound | https://github.com/iamthefrogy/BountyHound | Auto-weekly tracker of top bug bounty repos |
...
| Repo | URL | Type |
|------|-----|------|
| sql-injection-payload-list | https://github.com/payloadbox/sql-injection-payload-list | SQLi payloads |
| xxe-injection-payload-list | https://github.com/payloadbox/xxe-injection-payload-list | XXE payloads |
| ssrf-parameters | https://github.com/lutfumertceylan/top25-parameter/blob/master/ssrf-parameters.txt | SSRF parameter names |
| LFI-files | https://github.com/hussein98d/LFI-files | LFI file paths |
...
## HACKERONE DISCLOSED REPORTS (Top 2025)

| Bounty | Report URL | Program | Technique |
|--------|------------|---------|-----------|
| $35,000 | https://hackerone.com/reports/2293343 | GitLab | ATO via Password Reset |
| $25,000 | https://hackerone.com/reports/3000510 | HackerOne | IDOR on `/reports/:id.json` |
| $25,000 | https://hackerone.com/reports/1618347 | HackerOne | GraphQL introspection |
| $15,000 | https://hackerone.com/reports/3018307 | Cosmos | Governance DoS |
| $12,500 | https://hackerone.com/reports/3113398 | HackerOne | SSRF → Confluence |
| $10,000 | https://hackerone.com/reports/3124517 | GitHub | Arbitrary repo read |
| $10,000 | https://hackerone.com/reports/2900606 | PlayStation | Kernel stack free |
| $8,000 | https://hackerone.com/reports/1707287 | Internet Bug Bounty | Apache Airflow format string |
| $7,500 | https://hackerone.com/reports/2967634 | Reddit | Exposed proxy → internal |
| $6,000 | https://hackerone.com/reports/2995025 | Mozilla | VPN RCE via path traversal |
| $5,580 | https://hackerone.com/reports/1148364 | GitLab | OAuth token theft |
| $5,000 | https://hackerone.com/reports/3104356 | PlayStation | Blu-ray Java sandbox escape |
| $4,323 | https://hackerone.com/reports/3082917 | IBB | Session info leak |
| $4,323 | https://hackerone.com/reports/3031518 | IBB | CVE-2025-24813 RCE |
| $3,800 | https://hackerone.com/reports/1695604 | Shopify | Cache poisoning DoS |
| $3,500 | https://hackerone.com/reports/2885269 | Shopify | Privilege escalation |
| $2,700 | https://hackerone.com/reports/2937622 | HackerOne | Public GitHub repos |
| $2,162 | https://hackerone.com/reports/2921724 | IBB | Kernel deadlock |
| $2,000 | https://hackerone.com/reports/3176157 | PortSwigger | DNS rebinding SSRF in MCP |

**Full 2025 list:** https://github.com/ajaysenr/HackerOne-Disclosed-Reports/blob/main/by-year/2025.md
...
| Handle | URL | Focus |
|--------|-----|-------|
| @m0chan98 | https://x.com/m0chan98 | Volume hunter (2,679 vulns, 165 critical), scope aggregator tool |
| @Behi_Sec | https://x.com/Behi_Sec | Beginner roadmap, tools, IDOR→$5k ATO, path traversal→$40k RCE |
...
| Bug Bounty Write-Ups Community | https://x.com/i/communities/1489229152280530960 | Asset discovery, recon, OSINT |
...
| postMessage targetOrigin Bypass via IP Normalization | https://lab.ctbb.show/research/postmessage-targetorigin-bypass-via-ip-normalization | BugXplorer |
...
| Google Paid $12M in Bug Bounties 2024 | https://www.securityweek.com/google-paid-out-12-million-via-bug-bounty-programs-in-2024 | SecurityWeek |
...
| ysoserial.net | https://github.com/pwntester/ysoserial.net | .NET ViewState/BinaryFormatter gadgets |
...
## NOTES
- All Telegram channels fetched via public `t.me/s/username` previews (no login required)
- All GitHub repos fetched via raw.githubusercontent.com or GitHub API
- All H1 reports from ajaysenr/HackerOne-Disclosed-Reports (587 reports, 2025)
- X/Twitter accounts public profiles only
